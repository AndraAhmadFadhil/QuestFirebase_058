package com.example.pampertemuan14.ui.view
...
import com.example.pampertemuan14.ui.viewmodel.FormErrorState
import com.example.pampertemuan14.ui.viewmodel.FormState
import com.example.pampertemuan14.ui.viewmodel.InsertUiState
import com.example.pampertemuan14.ui.viewmodel.InsertViewModel
import com.example.pampertemuan14.ui.viewmodel.MahasiswaEvent
import com.example.pampertemuan14.ui.viewmodel.PenyediaViewModel
...
fun InsertMhsView (
    ...
    @SuppressLint("NewApi") viewModel: InsertViewModel = viewModel(factory = PenyediaViewModel.Factory)
) {
        ...
        when (uiState) {
            is FormState.Success -> {
                ...
                coroutineScope.launch {
                    ...
                    // Navigasi langsung
                    onNavigate()
                    viewModel.resetSnacBarMessage() // Reset snackbar state
                }
            }
            is FormState.Error -> {
                coroutineScope.launch {
